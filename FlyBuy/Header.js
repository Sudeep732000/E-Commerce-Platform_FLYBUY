...
function Header({ user }) {
    return (
        ...
        <Container>
            ...
            <HeaderNavs>
                <HeaderOptions>
                    <OptionOne>Hi!{user.name}</OptionOne>
                    <OptionTwo> Account Details</OptionTwo>
                </HeaderOptions>
                <HeaderOptions>
                    <OptionOne>Vouchers</OptionOne>
                    <OptionTwo> & Gifts</OptionTwo>
                </HeaderOptions>
                    <HeaderCart>
                        <Link to="/ShopCart">
